...
let
  sources = {
    ...
    "java-parser-2.3.0" = {
      ...
      version = "2.3.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/java-parser/-/java-parser-2.3.0.tgz";
        sha512 = "P6Ma4LU1w/e0Lr4SVM/0PtqCGoL2/i/KP9ZoiyLa824oBqhF0yGTgHDyZkLgp9GTzqR43wm5wabE56FF5X7cqg==";
      };
    };
    "lodash-4.17.21" = {
      name = "lodash";
  ...
  args = {
    ...
    packageName = "prettier-plugin-java";
    version = "2.6.0";
    src = ./.;
    dependencies = [
